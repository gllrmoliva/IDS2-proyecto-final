...
INSERT INTO "Incidente" ("id_incidente", "id_productor", "gravedad", "desc", "id_caso", "id_hito", "estado", "motivo_rechazo") VALUES
(1, '22222222-2', 'baja', 'Pelea menor en el patio durante el recreo.', 1, NULL, 'aceptado', NULL),            -- Asociado a Caso
(2, '33333333-3', 'media', 'Falta de respeto grave a la profesora durante clase.', NULL, 1, 'aceptado', NULL), -- Asociado a Hito
(3, '22222222-2', 'alta', 'Alumno rompió el ventanal con un balón.', 2, NULL, 'aceptado', NULL),               -- Asociado a Caso
(4, '22222222-2', 'alta', 'Alumno empujó a su compañero del quinto piso.', NULL, NULL, 'rechazado', NULL);      -- No elevado
